...
if 'lukecoburn' not in str(Path.home()):
    user = 'andrew'
    pickle_file_folder = '/Users/andrewbashorm/Dropbox/auto_processing/pickle_files/'
    excel_file_folder = '/Users/andrewbashorm/Dropbox/auto_processing/excel_files/'
    height_file_folder = '/Users/andrewbashorm/Dropbox/auto_processing/height_data_images/'
else:
    user = 'luke'
...
house_address = '67 Lynmouth Dr Ruislip HA4 9BY UK'
